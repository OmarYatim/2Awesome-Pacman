...
public class GhostFrightened : GhostBehavior
{
    ...
    {
        base.Awake();
        GameManager.PowerPelletEatenEvent += this.Enable;
    }

    private void OnDestroy() => GameManager.PowerPelletEatenEvent -= this.Enable;
    ...
    private void Flash()
    {
        if (!this.eaten)
        {
            this.white.GetComponent<Animator>().enabled = true;
            this.blue.enabled = false;
    ...
    {
        this.blue.GetComponent<Animator>().enabled = true;
